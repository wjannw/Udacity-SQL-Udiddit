...
"username"​ VARCHAR(​25​) U​ NIQUE​ ​NOT​ NULL ​CHECK​ (​LENGTH​(​TRIM​(​"username"​))>​0​),
...
"topic_id"​ INT ​REFERENCES​ "​ topics"​(​"topic_id"​) ​ON​ ​DELETE​ C​ASCADE​,
...
CASCADE​,
"post_id"​ INT ​REFERENCES​ ​"posts"​(​"post_id"​) ​ON​ ​DELETE​ C​ASCADE​,
"user_id"​ INT ​REFERENCES​ ​"users"​(​"user_id"​) ​ON​ ​DELETE​ S​ET​ NULL,
"text"​ TEXT ​NOT​ NULL
);
